...
class CampsiteDropdown extends Component {
    ...
    render() {
        ...
        if (this.props.user.userName) {
            content = (
                <div>
                    <select value='Please select a campsite.' onChange={this.handleChange}>
                        {this.props.campsite.map((campsiteInfo, i) => {
                            return (
                                <option key={i} value={campsiteInfo._id}>{campsiteInfo.site_name}</option>
                            )
                        }
                        )
                        }
